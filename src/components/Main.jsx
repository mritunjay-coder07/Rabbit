...
Join
            ...
            <h1 style={{marginLeft:"10px",marginBottom:"10px", color:'white'}}>{x.title}</h1>
            <img src={x.image} alt="" style={{borderRadius:"5%",width:"50vw"}} />


          <div style={{width:"400px",display:"flex",justifyContent:"space-around",alignItems:"center",alignItems:"center",height:"100px",marginTop:"5px"}}>
...
{/* upvote downvote button */}
        ...
        <div style={{width:"50px",height:"40px",backgroundColor:"#2A3236",zIndex:0,display:"flex",justifyContent:"center",alignItems:"center",borderTopLeftRadius:"50%",borderBottomLeftRadius:"50%"}}>
...
<div  style={{width:"5px",height:"40px",backgroundColor:"#2A3236",display:"flex",justifyContent:"center",alignItems:"center",zIndex:"3",color:"white"}} > {x.upvotes}</div>

        <div style={{width:"50px",height:"40px",backgroundColor:"#2A3236",display:"flex",justifyContent:"center",alignItems:"center",borderTopRightRadius:"50%",borderBottomRightRadius:"50%"}}>
...
{/* comment section */}
          ...
          <div style={{backgroundColor:"transparent",display:"flex",width:"100px",height:"40px",justifyContent:'center',alignItems:"center"}}>
            ...
            <div style={{width:"50px",height:"40px",display:"flex",justifyContent:"center",alignItems:"center",backgroundColor:"#2A3236",borderTopLeftRadius:"50%",borderBottomLeftRadius:"50%"}}>

            <svg xmlns="http://www.w3.org/2000/svg" width="20"  height="40" fill="white" className="bi bi-chat-dots-fill" viewBox="0 0 16 16">
            <path d="M16 8c0 3.866-3.582 7-8 7a9 9 0 0 1-2.347-.306c-.584.296-1.925.864-4.181 1.234-.2.032-.352-.176-.273-.362.354-.836.674-1.95.77-2.966C.744 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7M5 8a1 1 0 1 0-2 0 1 1 0 0 0 2 0m4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0m3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
            </svg>
            </div>

            <div style={{width:"5px",height:"40px",backgroundColor:"#2A3236"}}>

            </div>

            <div style={{fontSize:"15px",width:"50px",height:"40px",display:"flex",justifyContent:"center",alignItems:"center",color:"white",backgroundColor:"#2A3236",borderTopRightRadius:"50%",borderBottomRightRadius:"50%"}}>
              {x.commentsCount}
            </div>
...
{/* SHARE */}
            ...
            <div style={{display:"flex",alignItems:"center",width:"120px",height:"30px",justifyContent:"space-around",backgroundColor:"transparent",marginLeft:"13px"}}>
              <div style={{width:"50px",backgroundColor:"#2A3236",height:"40px",display:"flex",justifyContent:"center",alignItems:"center",borderTopLeftRadius:"50%",borderBottomLeftRadius:"50%"}}>
            ...
            <path d="M11 2.5a2.5 2.5 0 1 1 .603 1.628l-6.718 3.12a2.5 2.5 0 0 1 0 1.504l6.718 3.12a2.5 2.5 0 1 1-.488.876l-6.718-3.12a2.5 2.5 0 1 1 0-3.256l6.718-3.12A2.5 2.5 0 0 1 11 2.5"/>
              ...
              <div style={{backgroundColor:"#2A3236",width:"20px",height:"40px",display:"flex",justifyContent:"center",alignItems:"center"}}>

              </div>
              <div style={{ backgroundColor:"#2A3236",width:"50px",height:"40px",display:"flex",justifyContent:"center",alignItems:"center",borderTopRightRadius:"50%",borderBottomRightRadius:"50%"}}>
